...
Modelo_Dom_TVP_g <- tvPLM(Consumo_Domestico_Pc ~ CDD + HDD + Salarios + DB + D1
                          , data = Dados_Doméstico_fd,index = c("Regiao", "Ano"), method = c("random"),tkernel ="Epa")
...
Modelo_Dom_TVP_t <- tvPLM(Consumo_Domestico_Pc ~ CDD + HDD + Salarios + DB + D1
                          , data = Dados_Doméstico_fd,index = c("Regiao", "Ano"), method = c("random"),tkernel ="Triweight")
...
Modelo_Servicos_TVP_g <- tvPLM(Consumo_Servicos_Pc ~   CDD + HDD + VAB_Servicos_Pc + DD + D2
                               , data = Dados_Servicos_fd,index = c("Regiao", "Ano"), method = c("random") , tkernel = "Epa")
...
Modelo_Servicos_TVP_t <- tvPLM(Consumo_Servicos_Pc ~   CDD + HDD + VAB_Servicos_Pc + DD + D2
                               , data = Dados_Servicos_fd,index = c("Regiao", "Ano"), method = c("random") , tkernel = "Triweight")
...
Modelo_Agricultura_TVP_g <- tvPLM(Consumo_Agricultura_Pc ~ CDD + HDD + VAB_Agricultura_Pc + IB + I2
                                  , data = Dados_Agricultura_fd,index = c("Regiao", "Ano"), method = c("random"), tkernel = "Epa")
...
Modelo_Agricultura_TVP_t <- tvPLM(Consumo_Agricultura_Pc ~ CDD + HDD + VAB_Agricultura_Pc + IB + I2
                                  , data = Dados_Agricultura_fd,index = c("Regiao", "Ano"), method = c("random"), tkernel = "Triweight")
...
Modelo_Industria_TVP_g <- tvPLM(Consumo_Industria_Pc ~ CDD + HDD + VAB_Industria_Pc + IC + I3
                                , data = Dados_Industria_fd,index = c("Regiao", "Ano"), method = c("random"), tkernel = "Epa")
...
Modelo_Industria_TVP_t <- tvPLM(Consumo_Industria_Pc ~ CDD + HDD + VAB_Industria_Pc + IC + I3
                                , data = Dados_Industria_fd,index = c("Regiao", "Ano"), method = c("random"), tkernel = "Triweight")
...
Modelo_Total_TVP_g <- tvPLM(Consumo_Total_Pc ~ CDD + HDD + VAB_Total_Pc + DC + D2 + IC + I2
                            , data = Dados_Total_fd,index = c("Regiao", "Ano"), method = c("random"), tkernel = "Epa" )
...
Modelo_Total_TVP_t <- tvPLM(Consumo_Total_Pc ~ CDD + HDD + VAB_Total_Pc  + DC + D2 + IC + I2
                            , data = Dados_Total_fd,index = c("Regiao", "Ano"), method = c("random"), tkernel = "Triweight")
...
write.xlsx(Modelo_Dom_TVP_g$coefficients, 
           file = "D:/Users/SCruz/Desktop/Paper1_vfinal/Output R/AnaliseSensibilidade_2.xlsx", 
           sheetName = "Folha1", 
           col.names = TRUE, 
           row.names = TRUE,
           append = FALSE)
