...
Dados$Salarios <- log(Dados$Salarios/Dados$POP)
...
Modelo_Dom_TVP_g <- tvPLM(Consumo_Domestico_Pc ~ CDD + HDD + Salarios + DA + D1
...
Modelo_Dom_TVP_t <- tvPLM(Consumo_Domestico_Pc ~ CDD + HDD + Salarios + DC + D2
                          , data = Dados_Doméstico_fd,index = c("Regiao", "Ano"), method = c("random"),tkernel ="Gaussian")
...
Modelo_Servicos_TVP_g <- tvPLM(Consumo_Servicos_Pc ~   CDD + HDD + VAB_Servicos_Pc + DC + D1
...
Modelo_Servicos_TVP_t <- tvPLM(Consumo_Servicos_Pc ~   CDD + HDD + VAB_Servicos_Pc + DE + D3
                               , data = Dados_Servicos_fd,index = c("Regiao", "Ano"), method = c("random") , tkernel = "Gaussian")
...
Modelo_Agricultura_TVP_g <- tvPLM(Consumo_Agricultura_Pc ~ CDD + HDD + VAB_Agricultura_Pc + DE + D3
...
Modelo_Agricultura_TVP_t <- tvPLM(Consumo_Agricultura_Pc ~ CDD + HDD + VAB_Agricultura_Pc + IC + I3
                                  , data = Dados_Agricultura_fd,index = c("Regiao", "Ano"), method = c("random"), tkernel = "Gaussian")
...
Modelo_Industria_TVP_g <- tvPLM(Consumo_Industria_Pc ~ CDD + HDD + VAB_Industria_Pc + IB + I2
...
Modelo_Industria_TVP_t <- tvPLM(Consumo_Industria_Pc ~ CDD + HDD + VAB_Industria_Pc + ID + I4
                                , data = Dados_Industria_fd,index = c("Regiao", "Ano"), method = c("random"), tkernel = "Gaussian")
...
Modelo_Total_TVP_g <- tvPLM(Consumo_Total_Pc ~ CDD + HDD + VAB_Total_Pc + DB + D1 + IB + I1
...
Modelo_Total_TVP_t <- tvPLM(Consumo_Total_Pc ~ CDD + HDD + VAB_Total_Pc  + DD + D3 + ID + I3
                            , data = Dados_Total_fd,index = c("Regiao", "Ano"), method = c("random"), tkernel = "Gaussian")
...
write.xlsx(Modelo_Dom_TVP_g$coefficients, 
           file = "D:/Users/SCruz/Desktop/Paper1_vfinal/Output R/AnaliseSensibilidade_3.xlsx", 
           sheetName = "Folha1", 
           col.names = TRUE, 
           row.names = TRUE,
           append = FALSE)
